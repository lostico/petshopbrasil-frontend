...
export type { TextareaSize } from './textarea/textarea.component';
export type { SelectSize, SelectOption } from './select/select.component';
...
export type { PaginationConfig } from './pagination/pagination.component';
